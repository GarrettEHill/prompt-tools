# Remote generate bootstrap — changelog from reality
...
Fetch `{PROMPT_TOOLS_BASE}prompts/manifests/generate-changelog-manifest.md` and all bootstrap files listed.
